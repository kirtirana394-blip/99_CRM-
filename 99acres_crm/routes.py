    ...
    try:
        target_followup_data = [
            ...
            },
            {
                ...
                'status': 'Proposal Sent',
                'priority': 'High',
                'fu_desc': 'HOT Lead: Proposal sent for 2000-3000 sqft cafe commercial space in Gurgaon',
                'fu_hours': 7,
                'task_title': 'Follow up on cafe space proposal with Aman',
                'task_due_days': 1
            },
            {
                'name': 'Nimit Chaudhry',
                ...
                'status': 'Meeting Done',
                'priority': 'High',
                'fu_desc': 'Meeting completed for Golf Course Road commercial office space',
                'fu_hours': 12,
                'task_title': 'Send Golf Course Road office details to Nimit Chaudhry',
                'task_due_days': 1
            },
            {
                'name': 'Nasaruddin',
